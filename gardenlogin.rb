...
class Gardenlogin < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/grolu/gardenlogin/releases/download/v3.0.50/gardenlogin_darwin_arm64"
      sha256 "dummySHA256sum"
    else
      url "https://github.com/grolu/gardenlogin/releases/download/v3.0.50/gardenlogin_darwin_amd64"
      sha256 "dummySHA256sum"
    end
  elsif OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/grolu/gardenlogin/releases/download/v3.0.50/gardenlogin_linux_arm64"
      sha256 "dummySHA256sum"
    else
      url "https://github.com/grolu/gardenlogin/releases/download/v3.0.50/gardenlogin_linux_amd64"
      sha256 "dummySHA256sum"
